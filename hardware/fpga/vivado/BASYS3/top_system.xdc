...
## PMEM
set_property PACKAGE_PIN V17 [get_ports {pmem_rst_btn}]
  set_property IOSTANDARD LVCMOS33 [get_ports {pmem_rst_btn}]
...
#set_property PACKAGE_PIN V13 [get_ports {nesctrl_ctrl1_data[0]}]
#  set_property IOSTANDARD LVCMOS33 [get_ports {nesctrl_ctrl1_data[0]}]
#set_property PACKAGE_PIN V3 [get_ports {nesctrl_ctrl1_data[1]}]
#  set_property IOSTANDARD LVCMOS33 [get_ports {nesctrl_ctrl1_data[1]}]
#set_property PACKAGE_PIN W3 [get_ports {nesctrl_ctrl1_data[2]}]
#  set_property IOSTANDARD LVCMOS33 [get_ports {nesctrl_ctrl1_data[2]}]
#set_property PACKAGE_PIN U3 [get_ports {nesctrl_ctrl1_data[3]}]
#  set_property IOSTANDARD LVCMOS33 [get_ports {nesctrl_ctrl1_data[3]}]
#set_property PACKAGE_PIN P3 [get_ports {nesctrl_ctrl1_data[4]}]
#  set_property IOSTANDARD LVCMOS33 [get_ports {nesctrl_ctrl1_data[4]}]
#set_property PACKAGE_PIN N3 [get_ports {nesctrl_ctrl1_data[5]}]
#  set_property IOSTANDARD LVCMOS33 [get_ports {nesctrl_ctrl1_data[5]}]
#set_property PACKAGE_PIN P1 [get_ports {nesctrl_ctrl1_data[6]}]
#  set_property IOSTANDARD LVCMOS33 [get_ports {nesctrl_ctrl1_data[6]}]
#set_property PACKAGE_PIN L1 [get_ports {nesctrl_ctrl1_data[7]}]
